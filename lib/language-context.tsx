...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "cap.p2.name": "Vender",
    "cap.p2.obj": "Convertir atención en ingresos.",
    "cap.p2.items": "CRM integrado|Gestión de leads|Integración de redes|Embudos de venta|Checkout|Seguimiento comercial|Pipelines",
  ...
  en: {
    ...
    "cap.p2.name": "Sell",
    "cap.p2.obj": "Turn attention into revenue.",
    "cap.p2.items": "Built-in CRM|Lead management|Social integrations|Sales funnels|Checkout|Commercial follow-up|Pipelines",
