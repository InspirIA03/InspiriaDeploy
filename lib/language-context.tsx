...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "cap.title": "Cuatro pilares. Un solo sistema.",
    "cap.subtitle": "Lo que podrás hacer dentro",
    "cap.intro": "Todo lo que puedes construir dentro de la plataforma.",
    "cap.counter": "Pilares",
    "cap.objLabel": "Objetivo",
    "cap.allowsLabel": "Permite",
    "cap.p1.name": "Crear",
    "cap.p1.obj": "Transformar conocimiento en activos digitales y en tu propia comunidad.",
    "cap.p1.items": "Cursos|Tu propia comunidad (estilo Skool)|Membresías|Productos digitales|Ofertas|Landing pages|Funnels",
    "cap.p2.name": "Vender",
    "cap.p2.obj": "Convertir atención en ingresos, con las comisiones más bajas del mercado.",
    "cap.p2.items": "Comisiones más bajas del mercado|CRM integrado|Gestión de leads|Integración de redes|Embudos de venta|Checkout|Seguimiento comercial|Pipelines",
    "cap.p3.name": "Automatizar",
    "cap.p3.obj": "Reducir el trabajo manual.",
    "cap.p3.items": "Emails|SMS|WhatsApp|Workflows|Onboarding|Seguimiento",
    "cap.p4.name": "Escalar",
    "cap.p4.obj": "Crecer sin aumentar proporcionalmente el esfuerzo operativo.",
    "cap.p4.items": "Agentes de IA|Dashboards|Reportes|Afiliados|Optimización",
  ...
  en: {
    ...
    "cap.title": "Four pillars. One system.",
    "cap.subtitle": "What you can do inside",
    "cap.intro": "Everything you can build inside the platform.",
    "cap.counter": "Pillars",
    "cap.objLabel": "Goal",
    "cap.allowsLabel": "Lets you",
    "cap.p1.name": "Create",
    "cap.p1.obj": "Turn knowledge into digital assets and your own community.",
    "cap.p1.items": "Courses|Your own community (Skool-style)|Memberships|Digital products|Offers|Landing pages|Funnels",
    "cap.p2.name": "Sell",
    "cap.p2.obj": "Turn attention into revenue, with the lowest fees on the market.",
    "cap.p2.items": "Lowest fees on the market|Built-in CRM|Lead management|Social integrations|Sales funnels|Checkout|Commercial follow-up|Pipelines",
    "cap.p3.name": "Automate",
    "cap.p3.obj": "Reduce manual work.",
    "cap.p3.items": "Emails|SMS|WhatsApp|Workflows|Onboarding|Follow-up",
    "cap.p4.name": "Scale",
    "cap.p4.obj": "Grow without scaling operational effort proportionally.",
    "cap.p4.items": "AI agents|Dashboards|Reports|Affiliates|Optimization",
