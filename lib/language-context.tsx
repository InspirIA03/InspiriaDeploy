...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "cap.p1.name": "Crear",
    "cap.p1.obj": "Transformar conocimiento en activos digitales.",
    "cap.p1.items": "Cursos|Membresías|Productos digitales|Ofertas|Landing pages|Funnels",
    "cap.p2.name": "Vender",
  ...
  en: {
    ...
    "cap.p1.name": "Create",
    "cap.p1.obj": "Turn knowledge into digital assets.",
    "cap.p1.items": "Courses|Memberships|Digital products|Offers|Landing pages|Funnels",
    "cap.p2.name": "Sell",
